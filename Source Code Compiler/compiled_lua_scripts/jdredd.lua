...
local CFG = {
    ...
    RECOIL_ALT_DURATION_MS = 20, -- Signal pulse duration for alternate recoil outputs (lower to 40 if a standard typical weapon is used as an alternative weapon in-game)
