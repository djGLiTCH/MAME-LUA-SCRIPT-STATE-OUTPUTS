...
local CFG = {
    ...
    P1 = {
        ...
        RECOIL       = "auto", -- 0x00210077 is the recoil memory address for Point Blank, but will revert to script ammo recoil logic instead
        ...
        DAMAGE       = 0x001C00B3, -- 0x001C00B3 is the damage count memory address for Point Blank, and is needed to enable rumble/vibration when shooting bombs
