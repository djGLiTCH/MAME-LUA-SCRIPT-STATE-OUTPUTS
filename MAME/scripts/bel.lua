...
local CFG = {
    ...
    P1 = {
        ...
        RECOIL          = 0x005A87B0, -- Alternative recoil triggers can include: 0x005A87B0 > 0 for trigger press in-game for P1; 0x005B494B > 0 for a shot countdown
        RELOAD          = "auto",
    ...
    P2 = {
        ...
        LIFE            = 0x005B4A1B,
        LIFE_ALT        = "auto",
        RECOIL          = 0x005A87B1, -- Alternative recoil triggers can include: 0x005A87B1 > 0 for trigger press in-game for P2; 0x005B49CF > 0 for a shot countdown
        RELOAD          = "auto",
        DAMAGE          = 0x005A8138, -- 0x005A8138 > 0 when the red DAMAGE text appears on-screen for both players
        LAMP_START      = "lamp1",
        SHOTS_FIRED     = "auto",
