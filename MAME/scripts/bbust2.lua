...
local CFG = {
    ...
    P2 = {
        ...
        CREDITS      = 0x0018458b, -- If set to "auto" for CREDITS, then it will be determined using PLAYER_CREDIT_MEMORY_OFFSET, but if PLAYER_CREDIT_MEMORY_OFFSET is set to false, then PLAYER_MEMORY_OFFSET is used
        STATUS       = "auto",
        AMMO         = "auto",
        AMMO_ALT     = "auto",
        LIFE         = "auto",
