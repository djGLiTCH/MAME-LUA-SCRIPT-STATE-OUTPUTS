...
local CFG = {
    ...
    MIN_RECOIL_INTERVAL_MS = 80, -- Unknown recoil interval for dragngun (due to missing ammo memory address) but restricted to 80 to prevent light gun solenoid from overheating -- Minimum time gap between each signal pulse for recoil outputs (prevents burning out solenoids)
    ...
    RECOIL_HOLD_MS         = 80, -- Unknown recoil interval for dragngun (due to missing ammo memory address) but restricted to 80 to prevent light gun solenoid from overheating -- Minimum time gap between each signal pulse for recoil outputs when using recoil memory address and holding trigger (useful if recoil memory address >= 1 when holding trigger)
    ...
    P1 = {
        ...
        STATUS                  = 0x0011F1DC, -- P1 Status = 0x0011F1DC; P1 Status alternative memory address = 0x00100082
        STATUS_ACTIVE_VALUE     = false,
        STATUS_ALT              = false,
        STATUS_ALT_ACTIVE_VALUE = false,
        AMMO                    = false,
    ...
    P2 = {
        ...
        CREDITS                 = "auto",
        STATUS                  = 0x0011F1DD, -- P2 Status = 0x0011F1DD; P2 Status alternative memory address = 0x00100182
