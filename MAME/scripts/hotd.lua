...
local CFG = {
    ...
    COINS_PER_CREDIT = 1, -- 2 Credits to start a game, but only 1 Credit to continue a game
    ...
    RELOAD_DURATION_MS = 40,       -- Signal pulse duration for calculated reload outputs
    ...
    CREDITS     = 0x0051E868, -- Alternatives might include: 0x0051E868, 0x0051E888, 0x0051F4B8, 0X01D0000A, 0X01D0005E
    ...
    GAME_STATUS = 0x0051F4A0, -- Alternatives might include: 0x0051F4A0, 0x0051F4A2; If either = 1 then 1 player is active (can be either P1 or P2), if either = 2 then both 2 players are active
