...
local CFG = {
    ...
    P1 = {
        ...
        STATUS                  = 0x002377C8, -- P1 Status = 0x002377C8 (1 = Player Active, whether Alive or Dead); P1 Game Status (1 = Alive, 3 = Dead) = 0x002377C9
        STATUS_ACTIVE_VALUE     = false,
        STATUS_ALT              = false,
        STATUS_ALT_ACTIVE_VALUE = false,
        AMMO                    = 0x002377D3,
