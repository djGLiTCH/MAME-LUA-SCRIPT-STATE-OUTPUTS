...
local CFG = {
    ...
    P2 = {
        ...
        CREDITS      = false, -- If set to "auto" for CREDITS, then it will be determined using PLAYER_CREDIT_MEMORY_OFFSET, but if this is false, then PLAYER_MEMORY_OFFSET is used
        STATUS       = 0x0000A047,
        AMMO         = 0x0000C07E,
        AMMO_ALT     = 0x0000A068,
        LIFE         = 0x0000A053,
