...
function stateoutput.startplugin()
    ...
    -- database_mame_driver.lua (v9.0.4) is the DRIVER-keyed companion to the ROM-keyed table
    ...
    local success_mame_driver, mame_driver_db = pcall(require, "stateoutput/database_mame_driver")
    if not success_mame_driver then
        success_mame_driver, mame_driver_db = pcall(require, "database_mame_driver")
    ...
    local PLUGIN_DATE_NUM    = 20260721
    ...
    -- database_mame_driver.lua is keyed, and the same key MAME itself uses
    ...
    local function on_start()
        ...
        if db and type(db) == "table" and db[rom_name] then
            ...
            -- back to database_driver.lua's auto-scraped entry for this ROM exactly as
            -- v9.0.4 did (regenerated wholesale by msop_database_driver_compiler.py -
            -- never hand-edit it).
            --
