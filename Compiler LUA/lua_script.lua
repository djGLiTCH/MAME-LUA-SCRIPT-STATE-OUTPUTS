...
local CFG = {
    ...
    DATA_WIDTHS = {
        SCREEN_FLASH          = {{DATA_WIDTHS.SCREEN_FLASH}},{{DATA_WIDTHS.SCREEN_FLASH_comment}}
    ...
    P1 = {
        ...
        STATUS_ACTIVE_VALUE     = {{P1.STATUS_ACTIVE_VALUE}},{{P1.STATUS_ACTIVE_VALUE_comment}}
        STATUS_ALT              = {{P1.STATUS_ALT}},{{P1.STATUS_ALT_comment}}
        STATUS_ALT_ACTIVE_VALUE = {{P1.STATUS_ALT_ACTIVE_VALUE}},{{P1.STATUS_ALT_ACTIVE_VALUE_comment}}
    ...
    P2 = {
        ...
        STATUS_ACTIVE_VALUE     = {{P2.STATUS_ACTIVE_VALUE}},{{P2.STATUS_ACTIVE_VALUE_comment}}
        STATUS_ALT              = {{P2.STATUS_ALT}},{{P2.STATUS_ALT_comment}}
        STATUS_ALT_ACTIVE_VALUE = {{P2.STATUS_ALT_ACTIVE_VALUE}},{{P2.STATUS_ALT_ACTIVE_VALUE_comment}}
    ...
    P3 = {
        ...
        STATUS_ACTIVE_VALUE     = {{P3.STATUS_ACTIVE_VALUE}},{{P3.STATUS_ACTIVE_VALUE_comment}}
        STATUS_ALT              = {{P3.STATUS_ALT}},{{P3.STATUS_ALT_comment}}
        STATUS_ALT_ACTIVE_VALUE = {{P3.STATUS_ALT_ACTIVE_VALUE}},{{P3.STATUS_ALT_ACTIVE_VALUE_comment}}
    ...
    P4 = {
        ...
        STATUS_ACTIVE_VALUE     = {{P4.STATUS_ACTIVE_VALUE}},{{P4.STATUS_ACTIVE_VALUE_comment}}
        STATUS_ALT              = {{P4.STATUS_ALT}},{{P4.STATUS_ALT_comment}}
        STATUS_ALT_ACTIVE_VALUE = {{P4.STATUS_ALT_ACTIVE_VALUE}},{{P4.STATUS_ALT_ACTIVE_VALUE_comment}}
