...
local CFG = {
    ...
    MIN_RECOIL_INTERVAL_MS     = 100, -- Appears to be 66ms for jpark but restricted to 100ms to prevent light gun solenoid from overheating 
    ...
    RECOIL_HOLD_MS             = 100, -- Appears to be 66ms for jpark but restricted to 100ms to prevent light gun solenoid from overheating 
