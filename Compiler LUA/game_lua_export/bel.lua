...
local CFG = {
    ...
    RECOIL_HOLD_MS             = 400, -- When ammo = 0, burst fire shot speed changes. First burst fire shot > small gap > second burst fire shot > large gap > restart from first burst fire shot. 
