...
local CFG = {
    ...
    ATTRACT_STATUS = 0x001843CA, -- Attract Status for bbust2 could be either 0x001843CA or 0x0018457F (they appear simultaneously under the exact same test conditions)
    ...
    P1 = {
        ...
        RECOIL                  = 0x0019B793, -- P1 Recoil for bbust2 is 0x0019B793 but noting that 0x001824B4 is P1 gun trigger press
        RELOAD                  = "auto",
        DAMAGE                  = "auto",
